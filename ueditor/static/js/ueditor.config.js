...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,savePath: [ 'wxpic' ]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        //, toolbars:[
        //    ['undo', 'redo', '|', 'fullscreen', 'fontsize', 'fontfamily', 'bold', 'italic', 'underline', 'forecolor', 'backcolor', 'pasteplain', '|', 'formatmatch', 'indent', 'justifyleft', 'justifycenter', 'justifyright', 'horizontal', 'insertimage', 'emotion', 'insertorderedlist', 'insertunorderedlist', 'spechars', 'inserttable', 'deletetable', 'searchreplace', 'preview', 'source']
        //]
