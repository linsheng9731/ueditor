...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:"/ueditor_scrawlUp"           //涂鸦上传地址
        ...
        ,snapscreenServerUrl: "/ueditor_imgup" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: ""
        ...
        //获取视频数据的地址
        ,getMovieUrl:"/ueditor_getMovie"                   //视频数据获取地址
...
//          ]
        ...
        //每一个对象就是一个自定义的样式
        //,'customstyle':[
        //      {tag:'h1', name:'tc', label:'居中标题', style:'border-bottom:#ccc 2px solid;padding:0 4px 0 0;text-align:center;margin:0 0 20px 0;'},
        //      {tag:'h1', name:'tl',label:'居左标题', style:'border-bottom:#ccc 2px solid;padding:0 4px 0 0;margin:0 0 10px 0;'},
        //      {tag:'span',name:'im', label:'强调', style:'font-style:italic;font-weight:bold;color:#000'},
        //      {tag:'span',name:'hi', label:'明显强调', style:'font-style:italic;font-weight:bold;color:rgb(51, 153, 204)'}
        //  ]
